...
public class Map implements Runnable {
    ...
    public Map(int mapId, String mapName, byte planetId,
        ...
        } else if (this.type == ConstMap.MAP_MA_BU) {
            countZone = MapMaBu.AVAILABLE;
        }
    ...
    public void initBoss() {
        for (Zone zone : zones) {
            ...
            switch (this.mapId) {
                case 114:
                    bossId = BossFactory.DRABURA;
                    break;
                case 115:
                    bossId = BossFactory.DRABURA_2;
                    break;
                case 117:
                    bossId = BossFactory.BUI_BUI;
                    break;
                case 118:
                    bossId = BossFactory.BUI_BUI_2;
                    break;
                case 119:
                    bossId = BossFactory.YA_CON;
                    break;
                case 120:
                    bossId = BossFactory.MABU_12H;
            }
            if (bossId != -1) {
