...
public class TaskService {
    ...
    public static com.nrolove.services.TaskService gI() {
        if (i == null) {
            i = new com.nrolove.services.TaskService();
        }
        return i;
    }
...
//            msg.writer().writeUTF(player.playerTask.taskMain.name); [" + player.playerTask.taskMain.id + "]
    ...
    public void checkDoneTaskPickItem(Player player, ItemMap item) {
        if (!player.isBoss && !player.isPet && !player.isNewMiniPet && item != null) {
    ...
    public void checkDoneTaskKillBoss(Player player, Boss boss) {
        if (player != null && !player.isBoss && !player.isPet && !player.isNewMiniPet) {
            switch ((int) boss.id) {
        ...
        if (TaskService.gI().isCurrentTask(player, idTaskCustom)) {
            ...
            switch (idTaskCustom) {
                ...
                case ConstTask.TASK_8_1:
                    ...
                    InventoryService.gI().addItemBag(player, capsule, false);
                ...
                case ConstTask.TASK_10_2:
                    ...
                    InventoryService.gI().addItemBag(player, skill2, false);
                    npcSay(player, ConstTask.NPC_QUY_LAO,
    ...
    public int getIdTask(Player player) {
        if (player.isPet || player.isNewMiniPet || player.isBoss || player.playerTask == null || player.playerTask.taskMain == null) {
            return -1;
