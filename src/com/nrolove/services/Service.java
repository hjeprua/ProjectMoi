...
//            }
            ...
            } else if (text.startsWith("love_upp")) {
                try {
            ...
            } else if (text.startsWith("love_up")) {
                try {
...
//                }
//                return;
//            } else if (text.equals("love_sconn")) {
//                sendThongBao(player, "Using: " + DBService.gI().currentActive() + " - avail: " + DBService.gI().currentIdle());
//            } else if (text.equals("love_msg")) {
//                sendThongBao(player, "Num of messages: " + player.getSession().getNumOfMessages());
...
//                } catch (Exception e) {
//                }
//            } else if (text.equals("logcontroller")) {
//                sendThongBao(player, (player.getSession().logCheck = !player.getSession().logCheck) ? "Bật" : "Tắt");
//                return;
            }
        }
...
//            sendThongBao(player, "Đã tạo được cái nịt MabuEgg: " + (player.mabuEgg != null));
//            //MabuEgg.createMabuEgg(player);
//        } else if (text.equals("love_freakyex")) {
//            System.exit(0);
//        } else if (text.equals("love_freakydb")) {
//            try {
...
//            }
    ...
    public void point(Player player) {
        ...
        Send_Info_NV(player);
        if (!player.isPet && !player.isBoss && !player.isNewMiniPet) {
            Message msg;
            try {
                msg = new Message(-42);
